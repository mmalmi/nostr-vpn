...
remote_env=(
  ...
  NVPN_MACOS_DAEMON_IDLE_CPU_SAMPLE_SECONDS="${NVPN_MACOS_DAEMON_IDLE_CPU_SAMPLE_SECONDS:-30}"
  NVPN_MACOS_DAEMON_IDLE_CPU_SETTLE_SECONDS="${NVPN_MACOS_DAEMON_IDLE_CPU_SETTLE_SECONDS:-45}"
)
